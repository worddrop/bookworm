...
class BookwormTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $story = $this->texts->minutesOfText(1,200);
    ...
    {
        $story = $this->texts->minutesOfText(8,200);
    ...
    {
        // 215 words
        $story = $this->texts->minutesOfMarkdown(3,200);
        $readingTime = Bookworm::estimate($story);
